			...
			<Container spacing={'VerticalXXXL'}>
				...
				<section>
					<button	className={`button ${button.primary}`}
							onClick={ () => window.location = 'mailto:agneyat2@gmail.com' } >
						{content.buttons.primary.title}
					</button>
					<button className={`button ${button.secondary} leaveSite`}
							onClick={ ()=> window.open("https://www.linkedin.com/in/agneya-tharun-408a14276/", "_blank") } >
						{content.buttons.secondary.title}
					</button>
					<button className={`button ${button.secondary} leaveSite`}
							onClick={ ()=> window.open("https://github.com/Vort3xed", "_blank") } >
						{content.buttons.tertiary.title}
					</button>
					<button className={`button ${button.secondary} leaveSite`}
							onClick={ ()=> window.open("https://www.instagram.com/agneya_t/", "_blank") } >
